            ...
            {books.length > 0 ? (
              books.map((book, index) => (
                <tr key={book._id} className="border-t hover:bg-gray-100">
                  ...
                  <td className="px-4 py-2 text-start max-w-28">
                    {book.title}
                  </td>
                  <td className="px-4 py-2 text-start truncate max-w-48">
                    {book.description}
                  </td>
                  ...
                  <td className="px-4 py-2 text-start max-w-24">
                    {book.category}
                  </td>
                  <td className="px-4 py-2 text-start max-w-24">
                    {book.author}
                  ...
                  <td className="px-4 py-2 text-start">
                    <img
                      src={book.coverImage}
                      alt="cover"
                      className="w-14 min-h-12 object-cover rounded"
                    />
                  </td>
                  <td className="px-4 py-2 text-start">
                    <a
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-90 z-30">
          <div className="p-3 rounded-xl max-w-2xl w-full mx-4">
            <div className="bg-white rounded-xl p-8 max-w-4xl w-full">
              <h3 className="text-2xl text-start font-bold mb-4">
                Delete Confirmation
              </h3>
              ...
              <div className="flex justify-end mt-4">
                ...
                <button
                  ...
                  className="btn btn-danger bg-red-700 hover:bg-red-900 text-white w-28 ms-2"
                >
                  Delete
                </button>
              </div>
