            ...
            books.map((book, index) => (
              <tr key={book._id} className="border-t hover:bg-gray-100">
                ...
                <td className="px-4 py-2 border">
                  <img src={book.coverImage} alt="cover" className="w-16 h-16 object-cover" />
                </td>
                <td className="px-4 py-2 border">
                  <a href={book.samplePdf} target="_blank" rel="noopener noreferrer" className="text-cyan-900">View Sample</a>
                </td>
                <td className="px-4 py-2 border">
                  <a href={book.sourcePath} target="_blank" rel="noopener noreferrer" className="text-cyan-900">View File</a>
                </td>
                <td className="px-4 py-2 border">
